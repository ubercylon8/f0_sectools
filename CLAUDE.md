...
Current skills: `defender/triage-incident`, `defender/posture-summary`, `defender/threat-hunt`, `entra/identity-risk-review`, `entra/conditional-access-audit`, `entra/privileged-access-review`. A test (`skills/test_skills_valid.py`) enforces valid frontmatter and the ≤60-char description limit on every `SKILL.md`.
