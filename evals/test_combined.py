...
@pytest.mark.asyncio
async def test_combined_registry_unions_all_58_tools():
...
def test_combined_tasks_tagged_with_origin_and_include_probes():
    ...
    # + 10 tenable + 16 projectachilles-actions + 8 purview + 19 sentinel = 112, plus probes.
